<?php 
	...
	{
		$param = mysql_real_escape_string($_POST['srchdonacii']);
	}
	else
	{
	...
	{
		$sql = "SELECT * FROM objavi WHERE Tip='Donacija' AND (Naslov LIKE '%$param%' OR Sodrzina LIKE '%$param%') ORDER BY Datum desc";
    ...
    <div class="main-carousel p-2" id="latestCarousel"> 
        ...
        <?php 
           ...
           // $sql = "SELECT COUNT(*) FROM objavi WHERE Tip='Donacija' ORDER BY Datum desc";
			...
			if($param != "")
			{
				$sql = "SELECT COUNT(*) FROM objavi WHERE Tip='Donacija' AND (Naslov LIKE '%$param%' OR Sodrzina LIKE '%$param%') ORDER BY Datum desc";
            }
           ...
           // $sql = "SELECT * FROM objavi WHERE Tip='Donacija' ORDER BY Datum desc LIMIT $offset, $rowsperpage";
			if($param != "")
			{
				$sql = "SELECT * FROM objavi WHERE Tip='Donacija' AND (Naslov LIKE '%$param%' OR Sodrzina LIKE '%$param%') ORDER BY Datum desc LIMIT $offset, $rowsperpage"; 
            }
