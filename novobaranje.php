...
<?php 
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sodrzina = mysql_real_escape_string($_POST['sodrzina']);
    $lokacija = mysql_real_escape_string($_POST['lokacija']);
    $kategorijaID = mysql_real_escape_string($_POST['kategorija']);
    ...
    if(!empty($_FILES["file"]["name"]))
    {
      ...
      if(in_array($fileType,$allowTypes))
      {
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"],$targetFilePath))
        {
          ...
          VALUES('$naslov','$sodrzina','$lokacija','Baranje','$fileName',$korisnikID,$kategorijaID)";
...
<body>
    ...
    <div class="container post-holder mx-auto">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="widgEditor">Опис на барањето за донација:</label>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="Kategorija" name="kategorija">
                ...
                <option value="7">Станбено прашање</option>
            ...
            <div class="form-group">
              ...
              <div class="mx-auto text-center">
                <button type="submit" class="btn btn-md mt-3 btn-info" name="submit" style="background-color:#3b8191">ДОДАДИ НОВО БАРАЊЕ</button>
              </div>           
        </form>
    </div>
